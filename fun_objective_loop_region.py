...
from fun_damagecost_region import damage
...
def objective(x,SVf1,SVf2,SVf3,SVf4,SVf5,SVf6,SVf7,SVf8,SVf9,SVf10,SVf11,SVf12,SVf13,SVf14,SVf15,SVf16,SVf17,SVf18,SVf19,SVf20,
    ...
    #### just do one iteration right now, change later !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

    for N in range(numiter,numiter+1):
        print(N)
        # flood estimation
        ...
        #damage_loss_c,inop_util_c,inop_tran_c,cost_util_c,cost_tran_c, df_cost_direct_sum_div  = damage.dmg_cost_vector(fld_h_c, flh, ftm, fid_dmg, crtcl_elv, bldgasst, bsmt, comarea, fldpln, numfl, bldgclass, div, df_fire, df_poli, df_hosp, df_nurs, df_schl, df_eoc, df_res11, df_res11b, df_res12, df_res12b, df_res2, df_res3, df_res3b, df_htl, df_com1, df_com2, df_com3, df_com4, df_com5, df_com7, df_com8, df_com9, df_com10, df_ind1, df_ind2, df_ind3, df_ind4, df_ind5, df_ind6, df_agr, df_rel, df_gov, df_elec,H_dmg,H_dmg1,N)
        #df_cost_direct_sum_div = damage.dmg_cost_vector(fld_h_c, flh, ftm, fid_dmg, crtcl_elv, bldgasst, bsmt, comarea, fldpln, numfl, bldgclass, div, df_fire, df_poli, df_hosp, df_nurs, df_schl, df_eoc, df_res11, df_res11b, df_res12, df_res12b, df_res2, df_res3, df_res3b, df_htl, df_com1, df_com2, df_com3, df_com4, df_com5, df_com7, df_com8, df_com9, df_com10, df_ind1, df_ind2, df_ind3, df_ind4, df_ind5, df_ind6, df_agr, df_rel, df_gov, df_elec,H_dmg,H_dmg1,N)
        df_cost_direct_sum_div  = damage.dmg_cost_vector(fld_h_w, flh, ftm, fid_dmg, crtcl_elv, bldgasst, bsmt, comarea, fldpln, numfl, bldgclass, div, df_fire, df_poli, df_hosp, df_nurs, df_schl, df_eoc, df_res11, df_res11b, df_res12, df_res12b, df_res2, df_res3, df_res3b, df_htl, df_com1, df_com2, df_com3, df_com4, df_com5, df_com7, df_com8, df_com9, df_com10, df_ind1, df_ind2, df_ind3, df_ind4, df_ind5, df_ind6, df_agr, df_rel, df_gov, df_elec,H_dmg,H_dmg1,N)
